...
# Predictor lives in predictor.py (pure Python, CPython-testable); alias the old names.
from predictor import (PREDICT_SINGLE_MIN, PREDICT_RANGE_COVERAGE,
                       smoothed_dist as _smoothed_dist,
                       predict_from as _predict_from)
